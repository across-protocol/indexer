...
export const DepositForBurnFields = [
  ...
  `COALESCE("sponsoredDepositForBurn"."originSender", "depositForBurn".depositor)::varchar as "depositor"`,
  `COALESCE("sponsoredDepositForBurn"."finalRecipient", "depositForBurn"."mintRecipient")::varchar as "recipient"`,
  ...
  `CASE WHEN "swapFlowInitialized".id IS NOT NULL AND "sponsoredDepositForBurn"."finalToken" IS NOT NULL THEN "sponsoredDepositForBurn"."finalToken" ELSE NULL END::varchar as "swapOutputToken"`,
...
export const OftSentFields = [
  ...
  `COALESCE("sponsoredOFTSend"."originSender", "oftSent"."fromAddress")::varchar as "depositor"`,
  `COALESCE("sponsoredOFTSend"."finalRecipient", "oftReceived"."toAddress")::varchar as "recipient"`,
  `"oftSent"."token"::varchar as "inputToken"`,
  `"oftSent"."amountSentLD"::varchar as "inputAmount"`,
  `"oftReceived"."token"::varchar as "outputToken"`,
  `CASE WHEN "swapFlowInitialized".id IS NOT NULL AND "sponsoredOFTSend"."finalToken" IS NOT NULL THEN "sponsoredOFTSend"."finalToken" ELSE NULL END::varchar as "swapOutputToken"`,
  `NULL::varchar as "swapOutputTokenAmount"`,
