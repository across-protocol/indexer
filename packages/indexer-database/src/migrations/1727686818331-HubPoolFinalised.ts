...
export class HubPoolFinalised1727686818331 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "evm"."proposed_root_bundle" ADD "finalised" boolean DEFAULT false NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "evm"."root_bundle_disputed" ADD "finalised" boolean DEFAULT false NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "evm"."root_bundle_executed" ADD "finalised" boolean DEFAULT false NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "evm"."root_bundle_canceled" ADD "finalised" boolean DEFAULT false NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "evm"."set_pool_rebalance_route" ADD "finalised" boolean DEFAULT false NOT NULL`,
    );
  }
